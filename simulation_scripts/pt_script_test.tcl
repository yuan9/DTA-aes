...
#set i {aes_cipher_top\/us23}
#set_current_design aes_cipher_top/us23

#set _groups ""
#foreach_in_collection i [get_cells ]  {
#create_power_group -name [get_object_name [current_design]]/[get_object_name $i]  $i;
#lappend _groups [get_object_name [current_design]]/[get_object_name $i]
#}

###############
#set_power_analysis_options -waveform_interval 0.001 -waveform_format out -waveform_output "yuan_power" -include all_with_leaf -include_groups $_groups
#set_annotated_power -internal_power 1 aes_cipher_top/us23/U257 
set cellleak "U971" 
set_power_analysis_options -waveform_interval 0.001 -waveform_format out -waveform_output "yuan_power" -include all_with_leaf
#set_power_analysis_options -waveform_output switching -waveform_interval 0.001 -waveform_format out -waveform_output "yuan_power" -include all_with_leaf -cells $cellleak 
#set_power_derate 0 -leakage -internal
#update_timing

check_power
update_power  
report_power_analysis_options
#report_power > yuan_PowerReport.txt
report_power -cell_power -verbose -hierarchy > yuan_PowerReport.txt
quit

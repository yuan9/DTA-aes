...
#for counter in {0..3}
do
cp /home/yuan9/DTA-aes/aes_cipher_top_tb_orig /home/yuan9/DTA-aes/aes_cipher_top_tb.v
...
sed -i "s/FEDCBA9876543210/$R1_hex/g" /home/yuan9/DTA-aes/aes_cipher_top_tb.v
sed -i "s/0123456789ABCDEF/$R2_hex/g" /home/yuan9/DTA-aes/aes_cipher_top_tb.v

#echo "gate-leve simulation"
make aes-commandline>>simulation.log
#make aes-commandline-wddl>>simulation.log
#make aes-commandline-lowpower>>simulation.log
#echo "power simulation"
pt_shell -f /home/yuan9/DTA-aes/simulation_scripts/pt_script_aes.tcl>>pt.log
#pt_shell -f /home/yuan9/DTA-aes/simulation_scripts/pt_script_aes.tcl
#echo "move fiels"

mkdir -p $results_folder/result_$counter

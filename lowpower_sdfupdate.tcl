...
read_verilog -netlist workdir/aes_netlist_lowpower.v
elaborate aes_cipher_top -library work -update
current_design aes_cipher_top
write_sdf -version 2.1 workdir/lowpower_aes.sdf
write -f ddc -hier aes_cipher_top -output workdir/lowpower_aes.ddc
quit

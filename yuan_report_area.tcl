...
#for checking the area of wddl design
#read_ddc /home/dtatest/DTA-aes/workdir/aes_synthesis.ddc

#for checking the area of wddl design
read_ddc /home/dtatest/DTA-aes/workdir/wddl_aes.ddc

#report the area of the design, note that don't trust the cell number reported here, it count one module as one cell. Should use size of collection
report_area
#report number of nets

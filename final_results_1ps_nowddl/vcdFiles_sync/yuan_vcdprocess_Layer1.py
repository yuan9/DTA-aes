...
#print file_split1[0]
for i in range (0,len(file_split1)-1):
    print i
...
#np.savetxt('sw_aes_wddl_byte14bit' + str(bitnumber)+ '.txt',sorted_dicleaksig , fmt='%s')
np.savetxt('lm_118_rank.txt',sorted_dicleaksig , fmt='%s')

...
def extract_reggate():
	...
	F1 = open('ACA_TVLA_phase12020-03-09-14-08.txt','r')
	#F1 = open('ACA_TVLA_phase1-' +time_str+ '.txt', 'w')
	#F1 = open('test.txt','r')
	file_string = F1.read()
	F1.close()
	file_split = file_string.split("\n")
...
if __name__ == '__main__':
	...
	np.savetxt('final_ACA_TVLA_phase2-'+time_str+'.txt', dic_gatepower_merge, fmt='%s')
	np.savetxt('final_ACA_TVLA_phase1-'+time_str+'.txt', dic_gatepower_merge2, fmt='%s')

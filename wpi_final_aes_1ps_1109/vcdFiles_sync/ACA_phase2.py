...
def extract_reggate():
	...
	F1 = open('wpi_phase1_byte0bit0_phase2input.txt','r')
	#F1 = open('test.txt','r')
	file_string = F1.read()
	F1.close()
	file_split = file_string.split("\n")
...
if __name__ == '__main__':
	...
	np.savetxt('final_phase2_bit0.txt', dic_gatepower_merge, fmt='%s')
	np.savetxt('final_phase1_bit0.txt', dic_gatepower_merge2, fmt='%s')    		

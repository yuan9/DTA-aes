...
aes-gui: gtl-vsim
	...
	vsim -voptargs=+acc=lprn -L work -i work.aes_cipher_top_tb -do wave.do +notimingchecks -sdfmax /aes_cipher_top_tb/dut=/home/yuan9/DTA-aes/workdir/aes_synthesis.sdf

...
analyze -format verilog -library work {../nand_lmdpl.v ../nand_tablegen.v ../../../lmdpl_common/boolean_mask_dualrail.v ../../../lmdpl_common/lmdpl_nl_lut.v}
#analyze -format verilog -library work {../nand_lmdpl.v ../nand_tablegen.v ../../../lmdpl_common/boolean_mask_dualrail.v ../../../lmdpl_common/lmdpl_nl_lut.v ../../../lmdpl_common/sage_gates.v}
#elaborate aes_cipher_top -library synopsys -update

elaborate nand_lmdpl -library work -update

# dont touch lmdpl non-linear gate:
set_dont_touch [get_cells -hier *lmdpl_nl_gate_inst*]

###################################################################
# Link Design
###################################################################
link
current_design nand_lmdpl
###################################################################
...
write_sdc workdir/nand_lmdpl_synthesis.sdc
write -f ddc -hier nand_lmdpl -output workdir/nand_lmdpl_synthesis.ddc
write_sdf -version 2.1 workdir/nand_lmdpl_synthesis.sdf
write -format verilog -hierarchy -output workdir/nand_lmdpl_netlist.v

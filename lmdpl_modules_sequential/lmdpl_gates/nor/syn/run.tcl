...
analyze -format verilog -library work {../nor_lmdpl.v ../nor_tablegen.v ../../../lmdpl_common/boolean_mask_dualrail.v ../../../lmdpl_common/lmdpl_nl_lut.v}
#analyze -format verilog -library work {../nor_lmdpl.v ../nor_tablegen.v ../../../lmdpl_common/boolean_mask_dualrail.v ../../../lmdpl_common/lmdpl_nl_lut.v ../../../lmdpl_common/sage_gates.v}
#elaborate aes_cipher_top -library synopsys -update

elaborate nor_lmdpl -library work -update
...
write_sdc workdir/nor_lmdpl_synthesis.sdc
write -f ddc -hier nor_lmdpl -output workdir/nor_lmdpl_synthesis.ddc
write_sdf -version 2.1 workdir/nor_lmdpl_synthesis.sdf
write -format verilog -hierarchy -output workdir/nor_lmdpl_netlist.v
